...
#source "${USHgfs}/atparse.bash"  # include function atparse for parsing @[XYZ] templated files (from UFS model)
...
[[ ${DO_CUBE2GAUS} = "YES" ]] && export OMP_NUM_THREADS=${NTHREADS_FV3:-1}
