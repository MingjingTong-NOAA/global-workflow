...
# forecast files
APREFIX=${APREFIX:-""}
ATMF03=${ATMF03:-${COM_ATMOS_HISTORY_PREV}/${GPREFIX}atm.f003.nc}
ATMF06=${ATMGES:-${COM_ATMOS_HISTORY_PREV}/${GPREFIX}atm.f006.nc}
ATMF09=${ATMF09:-${COM_ATMOS_HISTORY_PREV}/${GPREFIX}atm.f009.nc}
