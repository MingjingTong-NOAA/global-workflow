...
CONVINFO=${CONVINFO:-${FIXgsi}/global_convinfo_shield.txt}
vqcdat=${vqcdat:-${FIXgsi}/vqctp001.dat}
INSITUINFO=${INSITUINFO:-${FIXgsi}/global_insituinfo.txt}
OZINFO=${OZINFO:-${FIXgsi}/global_ozinfo_shield.txt}
...
OBERROR=${OBERROR:-${FIXgsi}/prepobs_errtable.global.shield}
...
&SETUP
  ...
  use_pbl=.false.,use_compress=.true.,nsig_ext=24,gpstop=45.,commgpstop=45.,commgpserrinf=1.0,
