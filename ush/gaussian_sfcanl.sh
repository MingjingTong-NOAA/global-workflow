...
cpreq "${FIXorog}/${CASE}/${orogfix}_oro_data.tile1.nc" "./orog.tile1.nc"
cpreq "${FIXorog}/${CASE}/${orogfix}_oro_data.tile2.nc" "./orog.tile2.nc"
cpreq "${FIXorog}/${CASE}/${orogfix}_oro_data.tile3.nc" "./orog.tile3.nc"
cpreq "${FIXorog}/${CASE}/${orogfix}_oro_data.tile4.nc" "./orog.tile4.nc"
cpreq "${FIXorog}/${CASE}/${orogfix}_oro_data.tile5.nc" "./orog.tile5.nc"
cpreq "${FIXorog}/${CASE}/${orogfix}_oro_data.tile6.nc" "./orog.tile6.nc"
