...
FV3_predet(){
  ...
  cpreq "${FIXgfs}/am/${O3FORC}"  "${DATA}/${subdir:-""}global_o3prdlos.f77"
  cpreq "${FIXgfs}/am/${H2OFORC}" "${DATA}/${subdir:-""}global_h2oprdlos.f77"

  # GFS standard input data

  ISOL=${ISOL:-2}

  cpreq "${FIXgfs}/am/global_solarconstant_noaa_an.txt" "${DATA}/${subdir:-""}solarconstant_noaa_an.txt"
  cpreq "${FIXgfs}/am/global_sfc_emissivity_idx.txt"    "${DATA}/${subdir:-""}sfc_emissivity_idx.txt"
...
#   local month mm
  ...
  cpreq "${FIXgfs}/am/global_climaeropac_global.txt" "${DATA}/${subdir:-""}aerosol.dat"
  if (( IAER > 0 )) ; then
    local file
  ...
  cpreq "${FIXgfs}/am/global_co2historicaldata_glob.txt" "${DATA}/${subdir:-""}co2historicaldata_glob.txt"
  cpreq "${FIXgfs}/am/co2monthlycyc.txt"                 "${DATA}/${subdir:-""}co2monthlycyc.txt"
