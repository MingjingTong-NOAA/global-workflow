...
class Tasks:
    SERVICE_TASKS = ['arch_vrfy', 'earc_vrfy', 'stage_ic', 'cleanup', 'globus', 'ens_globus', 'archomg']
    DTN_TASKS = ['arch_tars', 'earc_tars', 'fetch', 'getic', 'eget', 'getfcst']
    VALID_TASKS = ['aerosol_init', 'stage_ic', 'fetch', 'globus', 'ens_globus',
                   'prep', 'anal', 'sfcanl', 'analcalc', 'analdiag', 'arch_vrfy', 'arch_tars', "cleanup",
                   'ecen_fv3jedi', 'analcalc_fv3jedi', 'getic', 'init', 'eget', 'getfcst', 'analinc', 'gomg', 'archomg',
                   ...
                   'eobs', 'epos', 'esfc', 'eupd', 'eomg', 'eget', 'eupp', 'ergpos', 'ergarc',
