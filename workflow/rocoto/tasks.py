...
class Tasks:
    SERVICE_TASKS = ['getic', 'eget', 'getfcst', 'arch_vrfy', 'arch_tars', 'archomg', 'earc_vrfy', 'earc_tars', 'stage_ic', 'fetch', 'cleanup']
    VALID_TASKS = ['aerosol_init', 'stage_ic', 'fetch', 'getic', 'init', 'getfcst',
                   'prep', 'anal', 'sfcanl', 'analcalc', 'analdiag', 'analinc', 'gomg', 'arch_vrfy', 'arch_tars', 'archomg', "cleanup",
                   ...
                   'eobs', 'eomg', 'epos', 'esfc', 'eupd', 'eget', 'eupp', 'ergpos', 'ergarc',
