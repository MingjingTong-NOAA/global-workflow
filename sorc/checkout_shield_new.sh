...
#  checkout "gsi_enkf.fd" https://github.com/MingjingTong-NOAA/GSI.git" "df8a415"; errs=$((errs + $?))
...
if [[ $CHECKOUT_GSI == "YES" || $CHECKOUT_GDAS == "YES" ]]; then
  ...
  checkout "gsi_utils.fd"    "https://github.com/MingjingTong-NOAA/GSI-utils.git" "02d4950"; errs=$((errs + $?))
