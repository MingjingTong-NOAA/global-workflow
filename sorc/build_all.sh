...
Usage: ${BASH_SOURCE[0]} [-a UFS_app][-c build_config][-d][-f][-h][-v] [gfs] [gefs] [sfs] [gcafs] [shield] [gsi] [gdas] [all]
  -a UFS_app:
  ...
  Specified systems (gfs, gefs, sfs, gcafs, shield, gsi, gdas) are non-exclusive, so they can be built together.
EOF
  exit 1
}
...
supported_systems=("gfs" "gefs" "sfs" "gcafs" "shield" "gsi" "gdas" "all")
...
build_jobs=(
    ["ufs_gfs"]=8 ["ufs_gefs"]=8 ["ufs_sfs"]=8 ["ufs_gcafs"]=8 ["shield"]=1 ["gdas"]=8 ["gsi_enkf"]=2 ["gfs_utils"]=1 ["ufs_utils"]=1
