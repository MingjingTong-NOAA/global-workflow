...
mkdir shield.fd
checkout "shield.fd/SHiELD_build" "https://gitlab.gfdl.noaa.gov/Mingjing.Tong/SHiELD_build.git" "c168f70"; errs=$((errs + $?))
cd ../

# The checkout version should always be a speciifc commit (hash or tag), not a branch
checkout "ufs_utils.fd"    "https://github.com/MingjingTong-NOAA/UFS_UTILS.git" "f11fe59"          ; errs=$((errs + $?))
checkout "chgres_shield.fd" "https://github.com/MingjingTong-NOAA/UFS_UTILS.git" "b9cf01e"         ; errs=$((errs + $?))
