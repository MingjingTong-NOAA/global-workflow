...
# forecast files
APREFIX=${APREFIX:-""}
ATMF03=${ATMF03:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}atm.f003.nc}
ATMF06=${ATMGES:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}atm.f006.nc}
ATMF09=${ATMF09:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}atm.f009.nc}
