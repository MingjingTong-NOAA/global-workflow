"""
SHiELD forecast-only application configuration module.

This module defines the configuration for running the Global SHiELD
...
class SHiELDForecastOnlyAppConfig(AppConfig):
    """
    Class to define SHiELD forecast-only configurations.
