...
def input_args(*argv):
    ...
    *argv : list, optional
    ...
    shield = netparser.add_parser('shield', help='arguments for SHiELD')
    ...
    for subp in [gfscycled, gefsforecasts, sfsforecasts, gcafscycled, shieldcycled, shieldensregrid]:
