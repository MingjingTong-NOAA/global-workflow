...
class SHiELDTasks(Tasks):
    ...
    def getic(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': self.envars,
                     'cycledef': cycledef,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/getic.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def init(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': self.envars,
                     'cycledef': cycledef,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/init.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def dfetch(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': self.envars,
                     'cycledef': self.run,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/dfetch.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def analinc(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': self.envars,
                     'cycledef': self.run.replace('enkf', ''),
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/analinc.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def gomg(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': self.envars,
                     'cycledef': cycledef,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/gomg.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def efetch(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': efetchenvars,
                     'cycledef': cycledef,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/efetch.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def ergpos(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': self.envars,
                     'cycledef': self.run.replace('enkf', ''),
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/ergpos.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
